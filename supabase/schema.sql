...
create table public.users (
  ...
  -- Deduplication rule: 'email' | 'domain' | 'name_and_company'
...
-- ============================================================
-- 2. CRM_CONNECTIONS (OAuth tokens for any CRM/email provider)
-- ============================================================
create table public.crm_connections (
  id                uuid primary key default gen_random_uuid(),
  user_id           uuid not null references public.users(id) on delete cascade,
  provider          text not null,  -- 'gmail' | 'salesforce' | 'hubspot' | 'pipedrive' etc.
  access_token      text not null,
  refresh_token     text,
  provider_metadata jsonb default '{}',  -- e.g. { instance_url: '...' } for Salesforce
...
create index idx_crm_connections_provider on public.crm_connections(user_id, provider);


-- ============================================================
-- 3. COMPANIES (target companies from SF or manual entry)
-- ============================================================
...
-- ============================================================
-- 7. SCAN_RUNS (audit log for web app scans)
-- ============================================================
...
-- ============================================================
-- 8. JOB_SIGNALS (richer scan results, replaces job_posts)
-- ============================================================
